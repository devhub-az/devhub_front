    ...
    <div class="bg-radial-green bg-no-repeat bg-contain bg-opacity-60 relative" data-aos-easing="ease-out-quart"
        ...
        <section class="xl:container my-20 mx-4 sm:mx-0 xs:mx-0 lg:mx-auto overflow-hidden xs:px-4">
            <div class="flex space-x-10 rounded-xl w-full px-12 py-12 xs:block"
                ...
                <div class="h-full w-2/6 m-auto xs:w-full xs:mt-4">
                    <img class="z-10 m-auto" src="/images/about/pro.svg" alt="" height="353" width="232">
                </div>
            </div>
        </section>
        <section
            ...
            <div class="rounded-xl w-full px-12 pt-12" data-aos="fade-up"
                ...
                <p class="text-white font-semibold text-xl">
                    На случай, если вы не знаете, как подступиться к тому или иному формату, мы написали короткие
                    гайды,
                    о том, как сделать ваши материалы полезными и оформить так, чтобы было удобно читать.
                    <span class="text-gray-400">Лента помогает отслеживать за интересными новшествами в мире
                        IT.</span>
                </p>
                <div class="relative w-1/2 mt-12 mx-auto">
                    <img class="relative z-10" src="/images/about/iphone_cut.png"
            ...
            <div class="flex text-gray-700 space-x-2 xs:block xs:space-y-4 xs:space-x-0">
                <div class="space-y-4">
                    <div class="bg-white dark:bg-dpaper border p-2 h-28 dark:border-gray-700">
                        ...
                        <p class="text-sm dark:text-gray-400">Первыми узнали о сбое в Сети? Увидели новый продукт
                            раньше
                            всех?
                            Прочитали
                    ...
                    <div class="bg-white dark:bg-dpaper border p-2 h-28 dark:border-gray-700">
                        ...
                        <p class="text-sm dark:text-gray-400">Организовали умный дом за 10к рублей? Переехали в
                            Новую
                            Зеландию
                    ...
                    <div class="bg-white dark:bg-dpaper border p-2 h-28 dark:border-gray-700">
                        ...
                        <p class="text-sm dark:text-gray-400">Справились с непростой задачей? Расскажите по пунктам,
                            как
                            ее
                    ...
                    <div class="bg-white dark:bg-dpaper border p-2 h-28 dark:border-gray-700">
                        ...
                        <p class="text-sm dark:text-gray-400">Помните в подробностях, как зарождались вещи, к
                            которым
                            уже все
                    ...
                    <div class="bg-white dark:bg-dpaper border p-2 h-28 dark:border-gray-700">
                        ...
                        <p class="text-sm dark:text-gray-400">Вы перепробовали кучу моноколес, стриминговых сервисов
                            или
                            сред
                ...
                <div class="space-y-4">
                    <div class="bg-white dark:bg-dpaper border p-2 h-28 dark:border-gray-700">
                        ...
                        <p class="text-sm dark:text-gray-400">У вас особый взгляд на острый вопрос? Хотите это
                            обсудить?
                    ...
                    <div class="bg-white dark:bg-dpaper border p-2 h-28 dark:border-gray-700">
                        ...
                        <p class="text-sm dark:text-gray-400">Есть доступ к человеку с необычным опытом? Срочно
                            берите
                            его в
                    ...
                    <div class="bg-white dark:bg-dpaper border p-2 h-28 dark:border-gray-700">
                        ...
                        <p class="text-sm dark:text-gray-400">Накопилась подборка интересных ссылок и хочется
                            поделиться
                            своими
                    ...
                    <div
                        ...
                        <div class="px-3.5">
                            ...
                            <div class="markdown my-2 xs:hidden md:hidden sm:hidden">
                                ...
                                <p>
                                    Son dövrlərdə proqramçı olaraq yeni texnologiyalara nəinki adaptasiya olmaq
                                    hətda
                                    onları izləmək belə çox çətin hala gəlib. Texnologiyanın inkişaf tempi inanılmaz
                                    sürətə sahibdir. Buna görə da biz proqramçılar bu inkişaf tempini öz daxilimizdə
                                    də
            ...
            <div class="py-10">
                <div class="grid relative xs:block sm:block grid-cols-2 overflow-hidden">
                    ...
                    <div class="m-auto w-2/3 dark:text-gray-300">
                        ...
                        <p class="mb-4 font-light">Zamanla daha çox kontekst əlavə edin və yeni məzmun göstərmək
                            üçün
                            səsvermədən
                            istifadə edin.</p>
                    </div>
        ...
        <section class="lg:container xl:container mt-4 mx-4 sm:mx-0 xs:mx-0 lg:mx-auto py-12 relative">
            ...
            <div class="grid grid-cols-3 mt-2">
                ...
                <div class="flex space-x-2 p-4">
                    <span class="iconify text-3xl text-yellow-500" data-icon="tabler:bolt"
                          data-inline="false"></span>
                    <div>
                ...
                <div class="flex space-x-2 p-4">
                    <span class="iconify text-2xl dark:text-gray-300" data-icon="tabler:eye"
                          data-inline="false"></span>
                    <div>
                ...
                <div class="flex space-x-2 p-4">
                    ...
                    <div>
                        ...
                        <p class="text-base dark:text-gray-400">Пишите статьи, делитесь опытом и становитесь
                            популярные
                            среди коллег.</p>
                    </div>
                </div>
