        ...
        <div class="xs:h-auto lg:container mx-auto">
                ...
                <div class="items-start flex w-2/3 justify-between xs:block xs:w-full xs:px-4 xs:space-y-4">
                    <div class="flex flex-col">
                        ...
                        <ul class="space-y-2">
                            <li>
                                <a href="#"
                                   class="text-gray-500 hover:text-black dark:hover:text-gray-300 cursor-pointer">О
                                    проекте</a>
                            </li>
                            <li>
                                <a href="#"
                                   class="text-gray-500 hover:text-black dark:hover:text-gray-300 cursor-pointer">Обновления</a>
                            </li>
                        </ul>
                    </div>
                    <div class="flex flex-col">
                        ...
                        <ul class="space-y-2">
                            <li>
                                <a href="#"
                                   class="text-gray-500 hover:text-black dark:hover:text-gray-300 cursor-pointer">Как
                                    стать автором</a>
                            </li>
                            <li>
                                <a href="#"
                                   class="text-gray-500 hover:text-black dark:hover:text-gray-300 cursor-pointer">Правила</a>
                            </li>
                        </ul>
                    </div>
                    <div class="flex flex-col">
                        ...
                        <ul class="space-y-2">
                            <li>
                                <a href="#"
                                   class="text-gray-500 hover:text-black dark:hover:text-gray-300 cursor-pointer">
                                    {{ $t('1') }}
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#"
                                   class="text-gray-500 hover:text-black dark:hover:text-gray-300 cursor-pointer">Пожертвовать</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="flex justify-between xs:w-full xs:px-4 pb-4">
                <p class="block text-sm text-gray-500 pb-4 my-auto xs:p-0 xs:text-center">
                    &copy; 2019 – {{ moment().year() }} <span class="">«DevHub»</span>
                </p>
...
import select_menu from '@/components/plugins/select'
import switcher from '@/components/plugins/switcher'
